...
//    implementation(libs.quarkus.web.dependency) // swapping to web bundler for more extensive static web
...
//    testImplementation(libs.io.rest.assured.rest.assured)
    ...
    // runtimeOnly(libs.bootstrap.core)
    // runtimeOnly(libs.bootstrap.icons)
